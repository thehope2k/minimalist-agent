      ...
      >
        ...
        <div className="scroll-thin flex-1 overflow-y-auto px-5 py-4">
          <div className="flex flex-col gap-3">
            ...
            <Field
              label="Root path"
              hint="Sessions opened under this folder auto-join the project."
            >
              <div className="flex gap-2">
                <Input
                  ...
                  className="flex-1"
                />
                <Button variant="outline" size="sm" icon={FolderOpen} onClick={handlePickFolder}>
                  Pick
                </Button>
              </div>
            </Field>
            ...
            >
              <Select
                ...
                onChange={(v) => {
                  ...
                  if (
                    !connections
                      .find((connection) => connection.slug === v)
