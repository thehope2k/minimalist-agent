...
// Validate-then-repair via the shared lib/mermaid-normalize so model-emitted
// quirks parse identically to the live MermaidBlock.
// Returns null on failure so callers can fall back to a code block.

import { resolveMermaidSource } from '../mermaid-normalize';
