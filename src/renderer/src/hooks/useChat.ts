...
import {appendMessage, createSession, loadFullSession, replaceLastMessage, truncateSessionMessages, updateSessionMeta,} from '@/lib/sessions';
  ...
  useEffect(() => {
    ...
    return window.api.chat.onEvent((evt: ChatStreamEvent) => {
      ...
      if (evt.type === 'compaction') {
        ...
        // Append a permanent boundary marker after the in-flight assistant
        // bubble. The divider semantically reads "everything above this
        // line was compacted by the turn ending here". Appending (vs
