...
| Assistant body (identity, capabilities, read-first, **skills with global+project scope**, **extensions with correct paths**, mermaid, math, rich blocks, interaction guidelines, git co-author, web search) | `getAssistantPrompt()`                                           | always                         |                                            ~1,800 |
